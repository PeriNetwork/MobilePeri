...
class _UserProfileState extends State<UserProfile> {
  final PeriPostRepository periPostRepo = PeriPostRepository();
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // text with number of followers and number off followed
          Row(
          ...
          Expanded(
              child: ListView.separated(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  periPostRepo.getPostList()[index].author,
                                  style: TextStyle(
                                      fontSize: 20,
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  periPostRepo.getPostList()[index].title,
                                  style: TextStyle(
                                      fontSize: 30,
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold),
                                ...
                                Text(
                                  periPostRepo.getPostList()[index].description,
                                  style: TextStyle(
                                    fontSize: 15,
                                    color: Colors.white,
                                  ),
                  ...
                  separatorBuilder: (BuildContext context, int index) =>
                      const Divider(),
                  itemCount: periPostRepo.getPostList().length)),
        ],
      ),
    );
  }
